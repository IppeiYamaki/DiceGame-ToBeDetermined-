...
//                Debug.Log($"Layer{node.Layer} の {node.IndexInLayer + 1}マス目に移動 | タイプ:Treasure");
//                UnityEngine.SceneManagement.SceneManager.LoadScene(treasureSceneName);
//                break;

//            case NodeType.Item:
//                Debug.Log($"Layer{node.Layer} の {node.IndexInLayer + 1}マス目に移動 | タイプ:Item");
//                UnityEngine.SceneManagement.SceneManager.LoadScene(itemSceneName);
//                break;
